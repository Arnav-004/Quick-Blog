...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32 text-white'>
        ...
        <form action="" className='flex items-center justify-between max-w-2xl w-full md:h-13 h-12'>
            ...
            <button type="submit" className='md:px-12 px-8 h-full text-white bg-gray-500 hover:bg-primary/50 transition-all cursor-pointer rounded-md rounded-l-none'>Subscribe</button>
        </form>
    </div>
  )
}
